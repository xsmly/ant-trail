...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" /></svg>,
  },
  {
    ...
    <div className="w-64 bg-white border-r border-slate-200 flex flex-col">
      ...
      <div className="h-16 flex items-center px-6 border-b border-slate-100">
        <Link href="/dashboard" className="flex items-center gap-2.5">
          ...
          <div>
            <span className="font-bold text-slate-800 text-lg leading-none">Ant Trail</span>
            <span className="block text-[10px] text-slate-400 font-medium tracking-wider">KETAHANAN PANGAN</span>
          </div>
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="bg-green-50 rounded-lg p-3">
          <div className="text-xs font-semibold text-green-800 mb-1">Data Terakhir</div>
          <div className="text-xs text-green-600">
            15 wilayah · 5 komoditas<br />
            180 hari historis
          </div>
        </div>
      </div>
